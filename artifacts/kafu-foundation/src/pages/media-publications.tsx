...
const FALLBACK_PUBLICATIONS: Publication[] = [
  ...
  { id: "pub04", title: "Annual Report 2024", type: "Annual Report", year: 2024, description: "Comprehensive annual report covering enrolment statistics, financial performance, academic achievements, research output, infrastructure development, and strategic milestones for the year 2024.", cover_url: "/imgs/aerial-1.jpg", file_url: "#", pages: 68 },
  { id: "pub05", title: "Annual Report 2023", type: "Annual Report", year: 2023, description: "The 2023 Annual Report documenting the university's academic, financial, and operational performance including progress against the 2020–2025 Strategic Plan.", cover_url: "/imgs/health.jpg", file_url: "#", pages: 60 },
  { id: "pub06", title: "Research Digest 2024", type: "Research Publication", year: 2024, description: "An annual publication highlighting selected research projects, publications, and innovation activities from KAFU's five schools and research directorates.", cover_url: "/imgs/PIC1.jpg", file_url: "#", pages: 48 },
  { id: "pub07", title: "Strategic Plan 2025–2030", type: "Strategic Document", year: 2025, description: "The KAFU Strategic Plan 2025–2030 outlining the university's vision, mission, strategic objectives, and key performance indicators across five strategic pillars.", cover_url: "/imgs/campus-main.jpg", file_url: "#", pages: 80 },
  { id: "pub08", title: "Student Handbook 2025/2026", type: "Handbook", year: 2025, description: "Comprehensive guide for students covering academic regulations, conduct and discipline, student welfare services, clubs and societies, and campus life information.", cover_url: "/imgs/undergraduate.jpg", file_url: "#", pages: 96 },
  { id: "pub09", title: "The KAFU Chronicle — Issue 10 (Jul–Sep 2024)", type: "Newsletter", year: 2024, frequency: "Quarterly", description: "Covers mid-year enrolment statistics, the launch of the Health Sciences School, international partnership news, and staff promotions.", cover_url: "/imgs/art-culture.jpg", file_url: "#", pages: 24 },
  { id: "pub10", title: "The KAFU Chronicle — Issue 9 (Apr–Jun 2024)", type: "Newsletter", year: 2024, frequency: "Quarterly", description: "Features the Research Week 2024 highlights, student innovation showcase, sports day results, and community outreach activities.", cover_url: "/imgs/IMG_8696.jpg", file_url: "#", pages: 24 },
  { id: "pub11", title: "Quality Assurance Framework 2024", type: "Policy Document", year: 2024, description: "KAFU's Quality Assurance Framework outlining internal quality review mechanisms, programme monitoring, and performance evaluation processes aligned to CUE standards.", cover_url: "/imgs/health.jpg", file_url: "#", pages: 42 },
  { id: "pub12", title: "KAFU Prospectus 2024/2025", type: "Prospectus", year: 2024, description: "The official university prospectus for the 2024/2025 academic year containing programme listings, fee structures, and admission requirements.", cover_url: "/imgs/undergraduate.jpg", file_url: "#", pages: 104 },
];
