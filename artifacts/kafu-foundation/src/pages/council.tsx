...
const FALLBACK: CouncilMember[] = [
  {
    id: 1, name: "Prof. John Ong'ete", title: "Chairperson, University Council",
    photo_url: null, category: "chairperson", position_order: 1,
    credentials: ["PhD, University of Nairobi", "Fellow, Kenya National Academy of Sciences"],
    bio: "Prof. Ong'ete chairs the Council with a commitment to institutional excellence, financial prudence, and strategic leadership.",
  },
  {
    id: 2, name: "Dr. Susan Wamuyu", title: "Vice Chairperson, University Council",
    photo_url: null, category: "vice_chair", position_order: 2,
    credentials: ["PhD, Business Administration", "CPA (K)", "FCIPS"],
    bio: "Dr. Wamuyu brings deep expertise in corporate governance and financial management to the Council.",
  },
  {
    id: 3, name: "Prof. Peter Nyamuhanga Mwita", title: "Vice Chancellor — Ex-Officio",
    ...
    category: "ex_officio", position_order: 3,
    credentials: ["PhD, University of Nairobi", "MSc, Biomedical Sciences"],
    bio: "Prof. Mwita serves as Vice Chancellor of KAFU and sits on the Council as an ex-officio member.",
  },
];
