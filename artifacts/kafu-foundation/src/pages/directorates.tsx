...
const FALLBACK: DirectorateListItem[] = [
  ...
  { id: 11, name: "Directorate of Corporate Affairs",                    slug: "corporate-affairs",                  tagline: "Driving Institutional Governance and Compliance",        director_name: "Mr. Silas Rugut",               director_title: "Director, Corporate Affairs",                     director_photo_url: null,                                description: "Oversees institutional governance, legal compliance, board affairs, and corporate social responsibility.", position_order: 6 },
