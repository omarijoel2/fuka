...
Route::get('/staff', function (Request $request) {
    $staff = [
        ...
        [
            'slug' => 'prof-margaret-n-waweru',
            'title' => 'Prof.',
            'first_name' => 'Margaret',
            'middle_name' => 'N.',
            'last_name' => 'Waweru',
            'name' => 'Prof. Margaret N. Waweru',
            'designation' => 'Vice-Chancellor',
            'school' => null,
            'department' => 'Office of the Vice-Chancellor',
            'unit' => 'University Leadership',
            'email' => 'vc@kafu.ac.ke',
            'specializations' => ['Educational Leadership', 'Higher Education Management', 'Policy and Governance'],
            'photo' => null,
            'bio' => 'Prof. Waweru is the Vice-Chancellor of Kaimosi Friends University, providing strategic and academic leadership in line with the university\'s vision as Kenya\'s Spring of Knowledge.',
        ],
        [
...
Route::get('/staff/{slug}', function (string $slug) {
    $profiles = [
        'prof-margaret-n-waweru' => [
            ...
            'specializations' => ['Educational Leadership', 'Higher Education Management', 'Policy and Governance'],
            'photo' => null,
            'biography' => 'Prof. Margaret N. Waweru is the Vice-Chancellor of Kaimosi Friends University (KAFU), where she provides strategic leadership in pursuit of the university\'s vision as Kenya\'s Spring of Knowledge. Under her leadership, KAFU has continued to expand its academic portfolio, strengthen research partnerships, and affirm its founding Quaker values of integrity, service, and community. Prof. Waweru brings decades of experience in higher education management, institutional development, and academic policy at both national and regional levels.',
            'qualifications' => [
                ['year' => '2001', 'qualification' => 'Doctor of Philosophy (Education)', 'institution' => 'University of Nairobi'],
                ['year' => '1994', 'qualification' => 'Master of Education', 'institution' => 'Kenyatta University'],
                ['year' => '1990', 'qualification' => 'Bachelor of Education (Arts)', 'institution' => 'Kenyatta University'],
            ],
            'research_interests' => ['Higher education policy', 'University governance', 'Women in academic leadership', 'Quality assurance in African universities'],
            'teaching_areas' => ['Educational Leadership', 'Higher Education Administration'],
            'experience' => [
                ['start' => '2020', 'end' => 'Present', 'position' => 'Vice-Chancellor', 'institution' => 'Kaimosi Friends University'],
                ['start' => '2014', 'end' => '2020', 'position' => 'Deputy Vice-Chancellor (Academic Affairs)', 'institution' => 'Kaimosi Friends University'],
                ['start' => '2006', 'end' => '2014', 'position' => 'Dean, School of Education', 'institution' => 'Kaimosi Friends University'],
            ],
            'publications' => [],
            'awards' => [],
            'memberships' => ['Kenya National Commission for UNESCO', 'Inter-University Council for East Africa', 'Association of African Universities'],
        ],
