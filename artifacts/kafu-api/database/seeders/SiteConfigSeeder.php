        ...
        SiteConfig::setGroup('navigation', [
            'primary_nav' => [
                ...
                ['label' => 'Academics', 'url' => '/schools', 'children' => [
                    ...
                    ['label' => 'SESS — Education & Social Sciences',   'url' => '/schools/SESS'],
                    ['label' => 'SBE — Business & Economics',           'url' => '/schools/SBE'],
                    ['label' => 'SCIT — Computing & IT',                'url' => '/schools/SCIT'],
                    ['label' => 'SOS — Science',                       'url' => '/schools/SOS'],
                    ['label' => 'SHS — Health Sciences',               'url' => '/schools/SHS'],
                    ['label' => 'ODeL — Open, Distance & E-Learning',  'url' => '/directorates/open-distance-elearning'],
                    ['label' => 'Kobujoi Campus',                       'url' => '/campuses/kobujoi'],
                ...
                ['label' => 'Students', 'url' => '/student-services', 'children' => [
                ...
                ['label' => 'Media', 'url' => '/media', 'children' => [
                    ...
                    ['label' => 'Video Gallery',   'url' => '/media/videos'],
                    ['label' => 'Press Releases',  'url' => '/media/press-releases'],
                    ['label' => 'Publications',    'url' => '/media/publications'],
                    ['label' => 'Downloads',       'url' => '/media/downloads'],
                    ['label' => 'Branding',        'url' => '/media/branding'],
                ]],
                ...
                ['label' => 'Directorates', 'url' => '/directorates', 'children' => [
                    ['label' => 'Graduate Studies',                          'url' => '/directorates/graduate-studies'],
                    ['label' => 'Quality Assurance (DQA&MS)',               'url' => '/directorates/quality-assurance'],
                    ['label' => 'Open, Distance & e-Learning',              'url' => '/directorates/open-distance-elearning'],
                    ['label' => 'Research, Innovation & Outreach',          'url' => '/directorates/research-innovation'],
                    ['label' => 'University Linkages, Alumni & Career',     'url' => '/directorates/university-linkages-alumni-career'],
                    ['label' => 'ICT Services',                             'url' => '/directorates/ict'],
                    ['label' => 'Corporate Affairs',                        'url' => '/directorates/corporate-affairs'],
                    ['label' => 'Planning & Performance Contracting',       'url' => '/directorates/planning-performance-contracting'],
                    ['label' => 'Enterprise & Resource Mobilization',       'url' => '/directorates/enterprises-resource-mobilization'],
                ]],
                ['label' => 'International', 'url' => '/international', 'children' => [
                    ['label' => 'International Overview', 'url' => '/international'],
                    ['label' => 'Study at KAFU',          'url' => '/international/study'],
                    ['label' => 'Visa & Immigration',     'url' => '/international/visa'],
