    ...
    private function seedManagement(): void
    {
        $profiles = [
            [
                ...
                'category'       => 'vc',
                'bio'            => 'Prof. Peter Nyamuhanga Mwita was officially appointed Vice Chancellor of Kaimosi Friends University on 14 May 2025, having served in an acting capacity since February 2024. He holds a PhD from the University of Nairobi and has extensive experience in academic leadership, research management, and institutional development. Under his leadership, KAFU continues to advance its mission of quality education, research, and community engagement across Western Kenya.',
                'email'          => 'vc@kafu.ac.ke',
            ...
            [
                'name'           => 'Prof. Lilian A. Achola',
                'title'          => 'Deputy Vice Chancellor — Academic & Student Affairs',
                'category'       => 'dvc',
                'bio'            => 'Prof. Lilian Achola oversees all academic programmes, student welfare, curriculum development, and quality assurance within KAFU\'s five schools. She has championed the expansion of postgraduate programmes and the adoption of competency-based education across the university\'s undergraduate offerings.',
                'email'          => 'dvc-asa@kafu.ac.ke',
                'office'         => 'DVC Academic Office, Administration Block',
                'phone'          => '+254 777 373 640',
                'position_order' => 2,
            ],
            [
                'name'           => 'Prof. Emmanuel W. Waswa',
                'title'          => 'Deputy Vice Chancellor — Research, Innovation & Partnerships',
                'category'       => 'dvc',
                'bio'            => 'Prof. Emmanuel Waswa leads KAFU\'s research agenda, innovation ecosystem, and strategic partnerships. He has been instrumental in securing research grants, establishing research clusters, and positioning KAFU as a growing research institution in Western Kenya.',
                'email'          => 'dvc-rip@kafu.ac.ke',
                'office'         => 'DVC Research Office, Research & Innovation Centre',
                'phone'          => '+254 777 373 641',
                'position_order' => 3,
            ],
            [
                'name'           => 'Prof. Margaret Wanjala',
                'title'          => 'Deputy Vice Chancellor — Administration, Finance & Planning',
                'category'       => 'dvc',
                'bio'            => 'Prof. Margaret Wanjala oversees the university\'s administrative operations, financial management, and strategic planning processes. She has led significant improvements in institutional resource management and the development of KAFU\'s infrastructure and campus facilities.',
                'email'          => 'dvc-afp@kafu.ac.ke',
                'office'         => 'DVC Administration Office, Administration Block',
                'phone'          => '+254 777 373 642',
                'position_order' => 4,
            ],
            [
                'name'           => 'Dr. Francis Njoroge',
                'title'          => 'Registrar — Academic Affairs',
                'category'       => 'registrar',
                'bio'            => 'Dr. Francis Njoroge manages all academic registration, examinations, student records, graduation, and compliance with the Commission for University Education (CUE) standards. He ensures the integrity of academic processes across all schools and departments.',
                'email'          => 'registrar-academic@kafu.ac.ke',
                'office'         => 'Academic Registrar\'s Office, Administration Block',
                'phone'          => '+254 777 373 650',
                'position_order' => 5,
            ],
            [
                'name'           => 'Mrs. Alice Chebet',
                'title'          => 'Registrar — Administration',
                'category'       => 'registrar',
                'bio'            => 'Mrs. Alice Chebet oversees human resources, staff welfare, institutional governance compliance, and administrative operations at KAFU. She is responsible for all staff recruitment, policy implementation, and the management of university governance documents.',
                'email'          => 'registrar-admin@kafu.ac.ke',
                'office'         => 'Administration Registrar\'s Office, Administration Block',
            ...
            [
                ...
                'category'       => 'finance',
                'bio'            => 'Mr. Peter Odhiambo is responsible for the financial governance of KAFU, including budgeting, financial reporting, fee collection, procurement oversight, and compliance with the Public Finance Management Act. He has overseen significant improvements in KAFU\'s financial systems and reporting standards.',
            ...
            [
                'name'           => 'Mr. John Muhanji',
                'title'          => 'University Librarian',
                'category'       => 'library',
                'bio'            => 'Mr. John Muhanji oversees the KAFU University Library, institutional repository, e-resources, and information literacy programmes. He has led the expansion of digital library resources, giving students and researchers access to thousands of academic journals and e-books.',
                'email'          => 'library@kafu.ac.ke',
                'office'         => 'University Library, Main Campus',
                'phone'          => '+254 777 373 670',
                'position_order' => 8,
            ],
            [
                'name'           => 'Mr. Isaac Wafula',
                'title'          => 'Director — Information & Communication Technology',
                'category'       => 'ict',
                'bio'            => 'Mr. Isaac Wafula leads KAFU\'s ICT Directorate, overseeing the university\'s digital infrastructure, enterprise systems, network services, and e-learning platforms. He has spearheaded the implementation of the university\'s ERP system and the expansion of campus-wide internet connectivity.',
                'email'          => 'ict@kafu.ac.ke',
                'office'         => 'ICT Directorate, Technology Block',
                'phone'          => '+254 777 373 680',
                'position_order' => 9,
            ],
        ];
